...
namespace CitricosCaribe.Controllers
{
    public class VehiculoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Motor,Marca,Modelo")] Vehiculo vehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Motor,Marca,Modelo")] Vehiculo vehiculo)
        {
            if (id != vehiculo.ID)
            {
                return NotFound();
