//Tabla # 22 Contrato de compra nacional: IDProducto, IDEmpresa, CI, 
//Fecha de contrato, Fecha de pedido, Objeto del contrato, Tipo de pago, de una parte, 
...
{
    public class ContratoCompraNacional
    {
